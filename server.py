...
def firewall_rules():
    ...
    print("Defaultne je port 3389 povolen from any, doporucuji otevrit pouze pro potrebne IP tzn. netstat | grep 3389 a zjistit pro kterou IP posloucha.")
    os.system("sudo ufw enable")
    print("Aktualni status FW je nasledovny: \n")
    os.system("sudo ufw status")

def tvorba_ssh_uzivatele():
    jmeno = input("Vlozte prosim nazev pro uzivatele ktereho budete pouzivat pro login na SSH server.")
